      ...
      {modalType == "OtpModal" ? (
        <View style={styles.modalContent}>
          <AppText
            ...
            style={[
              styles.modalTitle,
              { color: colors.buttonBg, textDecorationLine: "underline" },
            ]}
            type={EIGHTEEN}
          >
            {optModalType == "phone"
              ? "OTP Send to your Phone Number OR Email ID"
              : "OTP Send to your Aadhar Registered Phone Number"}
          </AppText>
          <AppText weight={MEDIUM} style={styles.modalTitle} type={EIGHTEEN}>
            Enter the OTP
          </AppText>
          <OTPInputView
          ...
          {optModalType !== "phone" &&
            (resendButtonDisabledTime > 0 ? (
              <AppText type={FOURTEEN} style={styles.resendText}>
        ...
        <View style={styles.congratulationStyle}>
          <ImageBackground
          ...
          >
            <View style={styles.congratulationContainer}>
              ...
              <View style={{ marginTop: 20 }}>
                <AppText style={styles.congratulationTextStyle} type={TWENTY}>
            ...
            <View style={styles.btnContainerStyle}>
              <Button onPress={handleWaytoLogin} children="Way to Login" />
            </View>
          </ImageBackground>
        </View>
      )}
